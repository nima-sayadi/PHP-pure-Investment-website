...
if(!isset($_SESSION['user_mail'])){ 
    ...
    // $new = "seen";
    // $fnew = "manager";
    // $sql = "UPDATE tickets SET status = ? WHERE user=? AND from_status = ?";
    // if(!mysqli_stmt_prepare($stmt , $sql)){
    //     echo "SQLNotPreapred";
    //     exit();
    // }
    // else{
    //     mysqli_stmt_bind_param($stmt , "sss" , $new,$_SESSION['user_mail'] , $fnew);
            ...
            <div class="col-lg-12">
                <div class="portlet box border shadow">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                        <a href="https://emx.ir/faq" target="_blank" class="text-center mb-5 mt-2"><button class="btn btn-lg btn-primary" style="font-size:18px;">برای مشاهده سوالات متداول کلیک کنید.</button></a>
                            <div class="col-md-8 offset-md-2 chat-box">
                                <ul class="chat" style="overflow-y:scroll;max-height:350px">
                                    ...
                                    <li class="<?php if($row['from_status'] == "user"){echo "self";}else{echo "other";} ?>">
                                        <div class="message">
                                            <div class="content">
                                                <?php echo $row['msg']; ?>
                                            </div><!-- /content -->
