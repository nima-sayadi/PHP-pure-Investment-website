...
;(function($) {
  ...
  var methods = {
    init: function(settings) {
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: '#', 'class': self.opt.prevButtonClass+' button-back', html: self.opt.backLabel };
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: '#', 'class': self.opt.nextButtonClass+' button-next', html: self.opt.nextLabel };
  ...
  $.fn.stepy.defaults = {
    ...
    prevButtonClass : 'btn btn-warning',
    back            : undefined,
    backLabel       : '&lt; Back',
    block           : false, // WIP...
    description     : true,
